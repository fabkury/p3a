...
3. **Flash the firmware**: Download and run `p3a-flasher.exe` from the [releases folder](https://github.com/fabkury/p3a/tree/main/release/), or see the [flashing guide](docs/flash-p3a.md) for other options
