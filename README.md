...
**What you need:**
- [Waveshare ESP32-P4-WIFI6-Touch-LCD-4B](https://www.waveshare.com/esp32-p4-wifi6-touch-lcd-4b.htm) board ($39.99) (also on [Amazon](https://www.amazon.com/dp/B0FF3Z1NNL/))
...
| **Museums** | Browse public collections from the Art Institute of Chicago, Rijksmuseum, Victoria and Albert Museum, Wellcome Collection, the Statens Museum for Kunst (SMK), Harvard Art Museums, the Smithsonian, the Cleveland Museum of Art, and the Minneapolis Institute of Art. Pick a department, category, or curated set; the device refreshes the listing on schedule. |
...
<p align="center"><em>Museum channels: works from the Art Institute of Chicago, Rijksmuseum, V&amp;A, Wellcome Collection, SMK, Harvard Art Museums, the Smithsonian, the Cleveland Museum of Art, and the Minneapolis Institute of Art.</em></p>
...
p3a runs on the **[Waveshare ESP32-P4-WIFI6-Touch-LCD-4B](https://www.waveshare.com/esp32-p4-wifi6-touch-lcd-4b.htm)** (also on [Amazon](https://www.amazon.com/dp/B0FF3Z1NNL/)), an off-the-shelf development board:
