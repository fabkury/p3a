...
1. From the device's Settings web UI, open the Makapix tab and click the Register button. The player calls the provision endpoint, gets a registration code, and displays it on the player's screen.
