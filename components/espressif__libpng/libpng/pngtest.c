...
#           endif
         ...
         /* p3a local fix: the APNG patch leaves this macro defined, which
          * collides with the identical #define in the non-APNG loop below.
          * (No-op when calc_pass_height made pass_height a variable.)
          */
#        undef pass_height
#ifdef PNG_WRITE_APNG_SUPPORTED
