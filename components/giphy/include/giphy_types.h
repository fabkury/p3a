...
/**
 * @file giphy_types.h
 * @brief Giphy channel entry structure (64-byte packed, matching makapix entry size)
 */
...
typedef struct __attribute__((packed)) {
    ...
    uint8_t reserved[26];         ///< [0]: rendition override (0=configured, 1=downsized_medium file, 2=downsized_medium via giphy.gif); [1..25]: future use
