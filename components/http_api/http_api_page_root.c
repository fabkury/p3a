 ...
 * @brief Main control page HTML/CSS/JS
 * 
 * Contains the main remote control page served at GET /
 */
...
esp_err_t h_get_root(httpd_req_t *req) {
    static const char html[] =
        ...
        "            if (buttons[i].textContent.indexOf('SD Card') !== -1) {"
    ...
    size_t html_buf_size = html_len + (size_t)injection_len + 1;
    ...
    size_t total_needed = current_pos + rest_len + 1;
