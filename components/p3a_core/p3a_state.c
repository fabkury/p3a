 ...
 *
 * Pre-redesign active-playset persistence (name string + __artwork__/__local__
 * sentinels + aw_* NVS keys) was removed in favour of the structured snapshot
 * in active_playset_store.c. Devices upgraded from older firmware retain the
 * obsolete NVS keys until a manual flash erase; nothing reads them.
 */
