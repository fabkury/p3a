...
/**
 * @file show_url.h
 * @brief Show-URL module interface: download artwork from URL and play
 */
 ...
 *
 * @param artwork_url URL of the artwork (must end with .gif, .webp, .jpg, .jpeg, .png, .apng, or .bmp)
