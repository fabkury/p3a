...
Copy WebP, GIF, PNG/APNG, JPEG, or BMP files to a `p3a/animations/` folder on a microSD card (i.e. create a `p3a` folder at the root of the card, and an `animations` folder inside it), then insert it into your p3a.
