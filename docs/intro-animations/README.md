...
**Phase: 3 IN PROGRESS — 13 of target 12+ animations registered.**
...
| 3 | Develop new animations (overshoot the final 12; cull to best 11) | 13 registered; batch 1+2 host-OK; batch 3 partial host-OK (pixel-rain, venetian, glitch-settle, typewriter, spiral-reveal); rejected: pixel-zoom, neon-trace, sparkle-fade, rotate-step |
...
Animation roster: 13 implemented (`smoothstep-fade` device-OK; the other 12
