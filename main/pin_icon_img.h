#ifndef PIN_ICON_IMG_H
#define PIN_ICON_IMG_H

#include <stdint.h>

extern const int pin_icon_img_w;
extern const int pin_icon_img_h;

/**
 * Fast blit the pin_icon_img image to a destination BGR888 buffer using memcpy.
 *
...
/**
 * Blit the pin_icon_img image with alpha blending, scaling, and rotation to a BGR888 buffer.
 *
