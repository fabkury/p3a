#ifndef REACTION_REVOKE_IMG_H
#define REACTION_REVOKE_IMG_H

#include <stdint.h>

extern const int reaction_revoke_img_w;
extern const int reaction_revoke_img_h;

/**
 * Fast blit the reaction_revoke_img image to a destination BGR888 buffer using memcpy.
 *
...
/**
 * Blit the reaction_revoke_img image with alpha blending, scaling, and rotation to a BGR888 buffer.
 *
