#ifndef SUBMIT_CLICK_IMG_H
#define SUBMIT_CLICK_IMG_H

#include <stdint.h>

extern const int submit_click_img_w;
extern const int submit_click_img_h;

/**
 * Fast blit the submit_click_img image to a destination BGR888 buffer using memcpy.
 *
...
/**
 * Blit the submit_click_img image with alpha blending, scaling, and rotation to a BGR888 buffer.
 *
