#ifndef UNPIN_ICON_IMG_H
#define UNPIN_ICON_IMG_H

#include <stdint.h>

extern const int unpin_icon_img_w;
extern const int unpin_icon_img_h;

/**
 * Fast blit the unpin_icon_img image to a destination BGR888 buffer using memcpy.
 *
 ...
 */
void unpin_icon_img_blit_memcpy_bgr888(
    uint8_t *dst,
    int dst_w,
    int dst_h,
...
/**
 * Blit the unpin_icon_img image with alpha blending, scaling, and rotation to a BGR888 buffer.
 *
 ...
 */
void unpin_icon_img_blit_pixelwise_bgr888(
    uint8_t *dst,
    int dst_w,
    int dst_h,
    int dst_stride_bytes,
