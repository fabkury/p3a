...
python -m esptool --chip esp32p4 -p COM5 -b 460800 --before default-reset --after hard-reset write-flash --flash_mode dio --flash_freq 80m --flash_size 32MB --force "@flash_args"

# Windows Command Prompt (replace COM5 with your port)
python -m esptool --chip esp32p4 -p COM5 -b 460800 --before default-reset --after hard-reset write-flash --flash_mode dio --flash_freq 80m --flash_size 32MB --force @flash_args

# Linux/macOS (replace /dev/ttyUSB0 with your port)
python -m esptool --chip esp32p4 -p /dev/ttyUSB0 -b 460800 --before default-reset --after hard-reset write-flash --flash_mode dio --flash_freq 80m --flash_size 32MB --force @flash_args
```
