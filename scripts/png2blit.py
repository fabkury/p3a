...
// Pixel-wise blit with alpha blending, scaling, and rotation support
...
def generate_header(name: str, width: int, height: int) -> str:
    ...
    lines.extend([
        '/**',
        f' * Blit the {name} image with alpha blending, scaling, and rotation to a BGR888 buffer.',
        ' *',
...
def generate_source(name: str, width: int, height: int, pixels: bytes,
    ...
    # Pixelwise blit function (with alpha, scaling, and rotation)
    lines.extend([
        f'void {name}_blit_pixelwise_bgr888(',
        '    uint8_t *dst,',
        '    int dst_w,',
